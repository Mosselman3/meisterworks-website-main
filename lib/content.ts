...
export const HOME_PRODUCTS = [
  {
    slug: "taatsdeur",
    title: "Taatsdeur",
    blurb: "Taatsmechaniek vloer en boven, voor een zwevend vlak.",
    alt: "Stalen taatsdeur",
  },
  {
    slug: "scharnierdeur-kozijn",
    title: "Scharnierdeur incl. kozijn",
    blurb: "Kozijn en scharnieren inbegrepen.",
    alt: "Scharnierdeur met stalen kozijn",
  },
  {
    slug: "schuifdeur",
    title: "Schuifdeur",
    blurb: "Inclusief rail en loopwerk.",
    alt: "Stalen schuifdeur",
  },
  {
    slug: "vast-paneel",
    title: "Vast paneel (los)",
    blurb: "Alleen een bevestigingsframe, zonder mechaniek.",
    alt: "Vast paneel in stalen frame",
  },
].map((item) => {
...
export const PRODUCT_STORIES = [
  {
    slug: "taatsdeur",
    kicker: "Taatsmechaniek",
    body: "De deur draait om een as in vloer en bovenkant, los van het kozijn. Geschikt voor grotere, zwaardere vlakken, met een zwevend effect.",
    cta: "Bekijk taatsdeur",
    dark: false,
    tinted: false,
    imageFirst: false,
    mark: "black" as const,
  ...
  {
    slug: "scharnierdeur-kozijn",
    kicker: "Inclusief kozijn",
    body: "Een scharnierdeur waarbij kozijn en scharnieren zijn inbegrepen. De vertrouwde bediening, strak uitgevoerd in staal.",
    cta: "Bekijk scharnierdeur",
    dark: true,
    tinted: false,
    imageFirst: true,
    mark: "white" as const,
  ...
  {
    slug: "schuifdeur",
    kicker: "Rail en loopwerk",
    body: "De deur loopt langs een rail, inclusief loopwerk. Geen zwaaiende deur nodig wanneer de ruimte naast de opening beperkt is.",
    cta: "Bekijk schuifdeur",
    dark: false,
    tinted: true,
    imageFirst: false,
    mark: "black" as const,
  ...
  {
    slug: "vast-paneel",
    kicker: "Zonder mechaniek",
    body: "Een los paneel met alleen een bevestigingsframe. Hetzelfde staal en glas als onze deuren, zonder bewegend deel.",
...
export const CONFIGURATOR_STEPS = [
  ...
  {
    num: "04",
    title: "Overzicht & gegevens",
    text: "Eerst controleert u uw keuzes, daarna vult u gericht uw gegevens in voor een vrijblijvende offerte.",
  },
] as const;
